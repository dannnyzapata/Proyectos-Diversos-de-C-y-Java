    ...
    public partial class FrmArbol : Form
    {
        ...
        private void BtnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (niveles == 1)
                {
                    if (TvArbol.Nodes[0].Nodes["NdDerecha"].Nodes.Find(TxtLetra.Text, true).Length > 0)
                    {
                        TvArbol.Nodes[0].Nodes["NdDerecha"].Nodes[TxtLetra.Text].Nodes.Add(TxtLetra.Text + "1", TxtLetra.Text + "1");
                    }
                }
                else
                {
